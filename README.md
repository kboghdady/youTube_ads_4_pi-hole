...
![List updated](https://img.shields.io/badge/list%20updated-Sept%2017th%202026-blue?style=for-the-badge)
...
Last updated: **Sept 17th 2026** - **15,869 domains** in the list - works with **Pi-hole v5 and v6**, **AdGuard Home**, **pfBlockerNG**, **Technitium** and any other DNS blocker that accepts a hosts-style domain list.
